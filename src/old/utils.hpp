...
template <typename T> class IO_in_if : virtual public sc_interface {
public:
...
template <typename T> class IO_out_if : virtual public sc_interface {
public:
...
public:
    DecoupledIO(sc_module_name name)
        : sc_channel(name)
